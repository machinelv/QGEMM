...
We changed the implementation of the kernel from swizzling to padding. And we achieve 96% performance.

| Problem Size | GEMM_kernel_v1 | GEMM_kernel_v2 | GEMM_kernel_v3 | cutlass_gemm_test | reference_cublas |
| --- | --- | --- | --- | --- | --- |
| M=512, N=512, K=512 | 6.082 | 8.947 | 12.080 | 4.819 | 35.910 |
| M=1024, N=512, K=2048 | 12.718 | 19.187 | 26.479 | 10.151 | 118.483 |
| M=2048, N=2048, K=2048 | 69.127 | 94.307 | 133.470 | 40.060 | 150.333 |
| M=4096, N=4096, K=4096 | 78.138 | 100.523 | 148.817 | 41.265 | 143.380 |
| M=8192, N=4096, K=2048 | 80.178 | 100.756 | 145.226 | 39.699 | 152.036 |
| M=8192, N=4096, K=4096 | 85.299 | 101.358 | 149.488 | 40.243 | 155.102 |
| M=8192, N=8192, K=4096 | 85.892 | 101.775 | 145.549 | 40.775 | 153.616 |
| M=8192, N=8192, K=8192 | 84.852 | 102.772 | 149.453 | 40.635 | 156.047 |

| Problem Size | GEMM_kernel_v1 | GEMM_kernel_v2 | GEMM_kernel_v3 | cutlass_gemm_test | reference_cublas |
| --- | --- | --- | --- | --- | --- |
| M=512, N=512, K=512 | 0.17x | 0.25x | 0.34x | 0.13x | 1.00x |
| M=1024, N=512, K=2048 | 0.11x | 0.16x | 0.22x | 0.09x | 1.00x |
| M=2048, N=2048, K=2048 | 0.46x | 0.63x | 0.89x | 0.27x | 1.00x |
| M=4096, N=4096, K=4096 | 0.55x | 0.70x | 1.04x | 0.29x | 1.00x |
| M=8192, N=4096, K=2048 | 0.53x | 0.66x | 0.95x | 0.26x | 1.00x |
| M=8192, N=4096, K=4096 | 0.55x | 0.65x | 0.96x | 0.26x | 1.00x |
| M=8192, N=8192, K=4096 | 0.56x | 0.66x | 0.95x | 0.27x | 1.00x |
| M=8192, N=8192, K=8192 | 0.54x | 0.66x | 0.96x | 0.26x | 1.00x |
