                    ...
                    size_t M, size_t N, size_t K)
{
    ...
    constexpr GEMM_Config config = sm89::config_64_64_64_1_4;
    sm89::launch_bf16_kernel_v4<config.BLOCK_TILE_SIZE_M, config.BLOCK_TILE_SIZE_N, config.BLOCK_TILE_SIZE_K, config.GROUP_SIZE_M, 2>(A, ldA, B, ldB, C, ldC, M, N, K);
}
