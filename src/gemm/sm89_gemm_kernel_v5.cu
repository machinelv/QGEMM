...
__global__ void GEMM_kernel_bf16_v5(const __nv_bfloat16* A, size_t ldA, const __nv_bfloat16* B, size_t ldB,
...
void launch_bf16_kernel_v5(const __nv_bfloat16* A, size_t ldA, const __nv_bfloat16* B, size_t ldB,
                       float* C, size_t ldC, size_t M, size_t N, size_t K) 
{
    ...
    GEMM_kernel_bf16_v5<float, BLOCK_TILE_SIZE_M, BLOCK_TILE_SIZE_N, BLOCK_TILE_SIZE_K, 
...
template<>
void GEMM_kernel_v5<__nv_bfloat16, float>(const __nv_bfloat16* A, size_t ldA,
                    ...
                    size_t M, size_t N, size_t K)
{
    ...
    constexpr size_t split_k = 2;
    sm89::launch_bf16_kernel_v5<config.BLOCK_TILE_SIZE_M, config.BLOCK_TILE_SIZE_N, config.BLOCK_TILE_SIZE_K, config.GROUP_SIZE_M>(A, ldA, B, ldB, C, ldC, M, N, K);
}

// Explicit template instantiation
template void GEMM_kernel_v5<__nv_bfloat16, float>(const __nv_bfloat16*, size_t, const __nv_bfloat16*, size_t, float*, size_t, size_t, size_t, size_t);
...
int main() {
    ...
    GEMM_kernel_v5(A, K, B, N, C, N, M, N, K);
